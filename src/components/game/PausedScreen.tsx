    ...
    <main className="mx-auto w-full max-w-2xl px-6 py-14">
      <header className="mb-8 text-center">
        ...
        <h1 className="text-3xl font-black tracking-tight">
          Sessão <span className="text-gradient">pausada</span>
        </h1>
      ...
      <div className="mt-6 space-y-3">
        {isHost ? (
          <Button variant="joy" size="lg" className="w-full" onClick={resume} disabled={busy}>
  ...
  return (
    <div className="rounded-2xl bg-[var(--surface-sunken)] py-4">
      <span
        className={
          highlight
            ? 'block text-3xl font-black text-gradient'
